<div class="body container ">
  ...
  <div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
      <div class="list">
        <?php
        while ($instructor = mysqli_fetch_array($data['listInstructor'])) {
          ?>
          <div class="item">
            <a class="photo" href="/muzzy/Instructor/IntructorDetail/<?php echo $instructor["id"] ?>">
              <img src="/muzzy/public/image/cafe.jpg" alt="" />
            </a>

            <div class="name-stars">
              <p class="name"><?php echo $instructor["fullname"] ?></p>
              <div class="stars">
            ...
            <p class="address"><?php echo $instructor["phonenumber"] ?></p>
          </div>
        <?php
        }
        ?>
