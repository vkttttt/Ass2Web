  ...
  <div class="container padding">
    <div class="box-title">
      <p><i class="fas fa-star"></i>Danh sách khoá học</p>
      <a href="/muzzy/Course">Xem tất cả</a>
    </div>
    <hr class="my-1 hr-cus">
    <div class="wraper-slider">
      <section class="slider-area slider">
        ...
        while ($row = mysqli_fetch_array($data['listCourse'])) {
          ...
          <div class="disable-current">
            <div class="wraper-item">
              <div class="deal-item">
                <a href="/muzzy/Course/CourseDetail/<?php echo $row["id"] ?>" class="avatar">
                  <img src="/muzzy/public/image/12.jpeg" alt="">
                </a>
                ...
                <hr>
                <p class="text-center">Giảng viên: <?php echo $row['fullname'] ?></p>
                <a href=<?php echo "https://www.google.com/maps/search/" . ProcessUrlMap($row['address']); ?> class="address">
                  <p class="text-address"> <i class="fas fa-map-marker-alt"></i> <?php echo $row['address'] ?> </p>
                </a>
              </div>
  ...
  <div class="container padding">
    <div class="box-title">
      <p><i class="fas fa-star"></i>Danh sách giảng viên</p>
      <a href="/muzzy/Instructor">Xem tất cả</a>
    </div>
    <hr class="my-1 hr-cus">
    <div class="wraper-slider">
      <section class="slider-area slider">
        <?php
        while ($row = mysqli_fetch_array($data['listInstructor'])) {
          ?>
          <div class="disable-current">
            <div class="wraper-item">
              <div class="deal-item">
                <a href="/muzzy/Instructor/IntructorDetail/<?php echo $row["id"] ?>" class="avatar">
                  <img src="/muzzy/public/image/12.jpeg" alt="">
                </a>
                ...
                <a href="#" class="address">
                  <p class="text-address"> <i class="fas fa-mobile-alt"></i> <?php echo $row['phonenumber'] ?> </p>
                </a>
              </div>
            </div>
          </div>
