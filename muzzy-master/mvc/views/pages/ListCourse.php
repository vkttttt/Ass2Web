  ...
  <div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
      <div class="list">
        ...
        while ($course = mysqli_fetch_array($data['listCourse'])) {
          ?>
          <div class="item">
            <a class="photo" href="/muzzy/Course/CourseDetail/<?php echo $course["id"] ?>">
              <img src="/muzzy/public/image/cafe.jpg" alt="" />
            </a>

            <div class="name-stars">
              <p class="name"><?php echo $course["content"] ?></p>
              <div class="stars">
                <?php
            ...
            <p class="address"><?php echo $course["address"] ?></p>
          </div>
        <?php
        }
        ?>
